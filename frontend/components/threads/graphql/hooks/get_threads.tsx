...
export type GetThreadsQuery = { __typename?: 'query_root', threads: Array<{ __typename?: 'threads', id: number, messages: Array<{ __typename?: 'messages', body: string, created_at: any, created_by: number }>, threads_users: Array<{ __typename?: 'threads_users', user: { __typename?: 'users', id: number, image_url?: string | null | undefined, name: string } }> }> };
