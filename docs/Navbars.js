    ...
    <div id="Nav.bar" {...props}>
      <Header className="mt-md-5">
        <Header.Body>
          ...
          <Header.Subtitle>
            Powerful and responsive navigation header, the navbar. Includes support for branding, navigation, and more,
            including support for the collapse plugin.
          </Header.Subtitle>
        </Header.Body>
      </Header>
      <Card>
      ...
      <p className="text-muted mb-4">
        Creates a vertical variation of the Navbar component. The markup for everything else remains the same as the
        default Navbar!
      </p>
      <Card>
        <Card.Body>
