...
export default function PageHeaders({ ...props }) {
  ...
  return (
    <div id="pageHeaders" {...props}>
      ...
      <p className="text-muted mb-4">
        Below you can find the detailed props API for the <code>Header</code>, <code>Header.AvatarTop</code>,{' '}
        <code>Header.Body</code>, <code>Header.Footer</code>, <code>Header.ImageTop</code>, <code>Header.Pretitle</code>
        , <code>Header.Subtitle</code>, <code>Header.Tabs</code>, and <code>Header.Title</code> components.
      </p>
