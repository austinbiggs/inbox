    ...
    <div id="forms" {...props}>
      <Header className="mt-md-5">
        <Header.Body>
          ...
          <Header.Subtitle>
            Dashkit React supports all of Bootstrap's default form styling in addition to a handful of new input types
            and features.
          </Header.Subtitle>
        </Header.Body>
      </Header>
      ...
      <Card>
        <Card.Body>
          <Dropzone accept="image/*" className="mb-3" onDrop={(acceptedFiles) => console.log(acceptedFiles)} />
      ...
      <p className="text-muted mb-4">
        A flexible and beautiful Select Input control for ReactJS with multiselect, autocomplete, async and creatable
        support.
      </p>
      <Card>
        <Card.Body>
