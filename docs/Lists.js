...
export default function Lists({ ...props }) {
  ...
  return (
    <div id="lists" {...props}>
      ...
      <p className="text-muted mb-4">
        Changes the color of the <code>.text-focus</code> elements to <code>$primary</code> on{' '}
        <code>ListGroup.Item</code> focus event. Useful for clickable <code>ListGroup.Item</code> elements when
      ...
      <p className="text-muted mb-4">
        Turn a list group into a timeline/activity list by adding the <code>.list-group-activity</code> modifier and/or
        modified avatars.
      </p>
      <Card>
        <Card.Header>
          ...
          <ListGroup className="list-group-flush my-n3">
            <ListGroup.Item>
              <Row>
                ...
                <Col className="ms-n2">
                  <div className="small">
                    <strong>Launchday Update email sent</strong> to 1,851 subscribers over a 24 hour period for maximum
