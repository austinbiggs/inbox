  ...
  return (
    <div id="navs" {...props}>
      ...
      <p className="text-muted mb-4">
        Creates a small variation of the nav component – this is especially useful for putting in{' '}
        <code>Card.Header</code> to act as tabs.
      </p>
      <Card>
        <Card.Body>
      ...
      <p className="text-muted mb-4">
        Creates a horizontally scrollable variation of the nav component. Items do not get stacked if they don't fit the
        viewport. Instead, they stay on the same line and become scrollable in the x axes.
      </p>
      <Card>
        <Card.Body>
